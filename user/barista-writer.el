;; barista-writer -*- lexical-binding: t; -*-
...
(font-lock-add-keywords 'writer-mode
             '(("^*+ " 0 `(:family "Codelia"
                           :height 140
                           :foreground ,barista-color-faded) prepend)
               ) 'append)
...
(define-derived-mode writer-mode org-mode "barista writer"

  ;; Faces
  (face-remap-add-relative 'org-level-1
                           :overline barista-color-subtle
