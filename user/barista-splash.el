;; barista Splash -*- lexical-binding: t; -*-
...
(defun show-splash ()
  ...
  (with-current-buffer "*splash*"
	...
	(beginning-of-buffer)
    (goto-char 0)
    (local-set-key [t] 'barista-splash-kill)))
...
(defun show-text ()
  (propertize (format-message "!!!" 'face 'barista-face-faded)))

(defun barista-splash-kill ()
